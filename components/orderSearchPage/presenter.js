...
import OrderScanInput from './step1';
import OrderInfo from './step2';
...
const Presenter = () => {
    ...
    return (
        <>
        <Stack.Navigator>
            <Stack.Screen name={STEP_NAVIGATE_ENUM.STEP1} component={OrderScanInput} options={Object.assign({ headerTitle: "주문정보" }, navigationOptions)} />
            <Stack.Screen name={STEP_NAVIGATE_ENUM.STEP2} component={OrderInfo} options={Object.assign({ headerTitle: "주문정보 상세" }, navigationOptions)} />
